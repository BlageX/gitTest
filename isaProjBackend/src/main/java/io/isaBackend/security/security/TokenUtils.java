package io.isaBackend.security.security;
...
import io.isaBackend.security.common.TimeProvider;
...
public class TokenUtils {
	...
	//sedam dana u sekundama
	@Value("604800000")
	private int EXPIRES_IN;

	//Naziv hedera u kojem ce biti token se zove Authorzation
	@Value("Authorization")
